...
/** Mirrors app/applicant/notifications/page.tsx: PageHeading
 *  (components/shared/PageHeading.tsx — h1 text-xl, mb-6 wrapper, mt-1
 *  description) + a Card wrapping ActivityTimeline's own shape (left
 *  border, dot, date/title/description per row) — same 3-item count as
 *  SAMPLE_APPLICATION_ACTIVITY. */
